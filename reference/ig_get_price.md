...
A tibble with price information, including columns like
\`marketStatus\`, \`bid\`, \`offer\`, \`high\`, \`low\`, \`updateTime\`,
and others as returned by the IG API \`/markets/{epic}\` endpoint.
