...
A tibble with historical OHLC data, including columns like
\`snapshotTime\`, \`openPrice\$bid\`, \`openPrice\$ask\`,
\`closePrice\$bid\`, \`closePrice\$ask\`, \`highPrice\$bid\`,
\`highPrice\$ask\`, \`lowPrice\$bid\`, \`lowPrice\$ask\`,
\`lastTradedVolume\`, and nested \`\$lastTraded\` fields.
